...
const navItems = [
  ...
  { label: "Add Course", helper: "Create", icon: FilePlus2, href: "/educator/add-course" },
  { label: "My Courses", helper: "Library", icon: BookOpenCheck, href: "/educator/my-courses" },
  { label: "Students", helper: "Learners", icon: Users, href: "/educator/students" },
  { label: "Assignments", helper: "Tasks", icon: FileText, href: "/educator/assignments" },
  { label: "Earnings", helper: "Revenue", icon: BadgeDollarSign, href: "/educator/earnings" },
  { label: "Messages", helper: "Inbox", icon: MessageSquare, href: "/educator/messages" },
  { label: "Reviews", helper: "Feedback", icon: Star, href: "/educator/reviews" },
      ...
      <AnimatePresence>
        {isSidebarOpen ? (
          <motion.div className="fixed inset-0 z-50 lg:hidden" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            <button
              aria-label="Close educator navigation"
          ...
          <div className="flex items-center justify-between gap-4 px-4 py-3.5 sm:px-6 lg:px-8">
            <div className="flex min-w-0 items-center gap-3">
              <button
                ...
                type="button"
                aria-label="Open educator navigation"
              >
    ...
    <div className="flex h-full flex-col">
      <RoleAwareLogoLink className="flex items-center gap-3 px-2 py-2" onClick={onNavigate}>
        ...
        <span>
          ...
          <span className="block text-xs font-bold text-slate-500 dark:text-slate-400">Educator studio</span>
        </span>
      </RoleAwareLogoLink>
