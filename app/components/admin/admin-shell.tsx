...
const navItems = [
  ...
  { label: "Students", helper: "Learners", icon: Users, href: "/admin/students" },
  { label: "Teachers", helper: "Partners", icon: GraduationCap, href: "/admin/teachers" },
  { label: "Courses", helper: "Catalog", icon: BookOpenCheck, href: "/admin/courses" },
  { label: "Analytics", helper: "Platform", icon: BarChart3, href: "/admin/analytics" },
  { label: "Revenue", helper: "Finance", icon: BadgeDollarSign, href: "/admin/revenue" },
  { label: "Approvals", helper: "Review queue", icon: CheckCircle2, href: "/admin/approvals" },
  { label: "Reports", helper: "Trust", icon: Flag, href: "/admin/reports" },
  { label: "Notifications", helper: "Broadcasts", icon: Bell, href: "/admin/notifications" },
...
export function AdminShell({ children }: Readonly<{ children: ReactNode }>) {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f6f8fb] text-slate-950 dark:bg-[#070b12] dark:text-white">
      <div className="fixed inset-0 -z-10 bg-[radial-gradient(circle_at_8%_8%,rgba(34,211,238,0.16),transparent_32%),radial-gradient(circle_at_92%_18%,rgba(16,185,129,0.12),transparent_30%),linear-gradient(180deg,#f8fafc,#eef3f9)] dark:bg-[radial-gradient(circle_at_8%_8%,rgba(45,212,191,0.14),transparent_30%),radial-gradient(circle_at_92%_18%,rgba(129,140,248,0.14),transparent_30%),linear-gradient(180deg,#070b12,#0f172a)]" />
          ...
          <div className="flex items-center justify-between gap-4 px-4 py-3.5 sm:px-6 lg:px-8">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="md:hidden">
                <p className="text-xs font-black uppercase tracking-[0.22em] text-cyan-600 dark:text-cyan-300">Class Hub</p>
                <h1 className="truncate text-lg font-black">Admin</h1>
              </div>
            </div>
...
function AdminSidebar({ onNavigate }: Readonly<{ onNavigate: () => void }>) {
